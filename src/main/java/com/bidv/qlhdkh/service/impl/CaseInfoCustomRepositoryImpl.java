...
public class CaseInfoCustomRepositoryImpl implements CaseInfoRepositoryCustom {
    ...
    @Override
    public List<CaseInfoModel> getListCaseInfo(String status, String projectName, String projectCode, String startDate, String endDate, String departmentCode, String branch, String caseType, String topicCategory, String fieldType) throws ParseException {
